...
<div style="display:flex;align-items:center;justify-content:center;gap:14px;margin-bottom:30px;">
    <div style="display:flex;align-items:center;">
        <img src="icon.png" style="width:36px;height:36px;display:block;">
    </div>

    <span style="font-weight:900;color:white;text-transform:uppercase;letter-spacing:0.2em;font-size:16px;line-height:1;">
        LunarDesk
    </span>
</div>
