...
if ($userCount == 0) {
    ...
    <body class="bg-slate-950 h-screen flex items-center justify-center text-white">
        <div class="bg-slate-900 p-8 rounded-xl shadow-2xl w-96 border border-slate-800">
            <h1 class="text-2xl font-bold mb-2">Welcome to your Workspace</h1>
...
if (empty($_SESSION['logged_in'])) {
    ...
    <body class="bg-slate-950 h-screen flex items-center justify-center text-white">
        <div class="bg-slate-900 p-8 rounded-xl shadow-2xl w-96 border border-slate-800">
            <h1 class="text-xl font-bold mb-6 text-center">Secure Access</h1>
...
<head>
    <meta charset="UTF-8">
    <title>Private Workspace <?php echo $app_version; ?></title>
...
<body class="bg-slate-950 h-screen overflow-hidden text-slate-300">
    <div id="app" class="flex h-full w-full">
        ...
        <aside class="bg-slate-900 flex flex-col shrink-0 z-20 shadow-xl" :style="{ width: midColWidth + 'px' }">
            <div class="flex flex-col h-full p-4">
                <div class="flex justify-between items-center mb-6 border-b border-slate-800 pb-4 shrink-0">
                    ...
                    <a href="?action=logout" class="text-xs text-red-400 hover:text-red-300 transition shrink-0 ml-2">Logout</a>
                </div>
        ...
        <div @mousedown="startDrag('midCol')" class="w-1.5 bg-slate-800 hover:bg-blue-500 cursor-col-resize z-50 transition-colors flex items-center justify-center group shrink-0 border-l border-r border-slate-900">
            <div class="h-8 w-0.5 bg-slate-600 group-hover:bg-white rounded-full"></div>
        </div>
